...
namespace LinkedListTest
{
    ...
    public class DoublyUnitTest2
    {
        ...
        {
            ILinkedList<ClubMember> list = new ADT.DoublyLinkedList<ClubMember>();
        ...
        {
            // ** int list test *********
            ILinkedList<int> listInt = new ADT.DoublyLinkedList<int>();
        ...
        {
            // ** string list test **********
            ILinkedList<string> listString = new ADT.DoublyLinkedList<string>();
        ...
        {
            // ** decimal list test ***********
            ILinkedList<decimal> listDecimal = new ADT.DoublyLinkedList<decimal>();
